...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None):
    ...
    # unpack the weights and the biases
    W1 = self.params['W1']
    b1 = self.params['b1']
    W2 = self.params['W2']
    b2 = self.params['b2']  
    ...
    # compute the scores
    hidden_layer_neurons, cache_hidden_layer = affine_relu_forward(X, W1, b1)
    scores, cache_scores = affine_forward(hidden_layer_neurons, W2, b2)
